...
<html lang="en">
    ...
    <body>
        ...
        <div class="navbar navbar-expand-lg bg-dark navbar-dark">
            <div class="container-fluid">
                <a href="index.html" class="navbar-brand">AFROHAIR</a>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="about.html" class="nav-item nav-link">Membres</a>
                       <!-- <a href="causes.html" class="nav-item nav-link active">Causes</a>  -->
                       <a href="event.html" class="nav-item nav-link active">Produits</a>
                        <a href="blog.html" class="nav-item nav-link">Catalogue</a>
    ...
    <div class="event">
        <div class="container">
            <div class="section-header text-center">
                <p>Nos produits</p>
                <h2>Découvrez notre choix de produits capillaires pour une beauté capillaire optimale !</h2>
            </div>
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="event-item">
                            <img src="img/activilong.jpg" alt="Image">
                            <div class="event-content">
                                <div class="event-meta">
                                    <p><i class="fa fa-calendar-alt"></i>01-Jan-45</p>
                                    <p><i class="far fa-clock"></i>8:00 - 10:00</p>
