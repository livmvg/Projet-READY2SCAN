            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <a href="../session/session.php">Connexion</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="contact">
            <div class="container">
                ...
                <div class="contact-form">
                        ...
                        <form action="session_action.php" method="post" >   <!-- Redirection vers une autre page PHP après validation  -->
                            
                            <div class="control-group">
                                <input type="text" class="form-control" name="pseudo" placeholder="Votre pseudo" maxlength="150"  data-validation-required-message="Saisissez votre pseudo" />
